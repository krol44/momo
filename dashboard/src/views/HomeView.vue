...
export default {
	data () {
		...
		return {
			...
			stopChat: false,
			filter: filter,
			filterSwitch: window.localStorage.getItem('filter-switch') === 'true',
			filterSelect: window.localStorage.getItem('filter-select') ? window.localStorage.getItem('filter-select')
				: 'filter',
			...
			beepFlag: window.localStorage.getItem('beep-flag') === 'true',
		}
	},
	watch: {
		filter: function (val) {
		...
		filterSwitch: function (val) {
			window.localStorage.setItem('filter-switch', val)
		},
		filterSelect: function (val) {
			window.localStorage.setItem('filter-select', val)
		},
		beepFlag: function (val) {
			window.localStorage.setItem('beep-flag', val)
		}
	},
	methods: {
		scrollDown: function () {
